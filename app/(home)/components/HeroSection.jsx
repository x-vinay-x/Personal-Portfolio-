    ...
    <section className="min-h-[calc(100vh-140px)] flex items-center justify-center relative">
      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          >
            <div className="flex items-center gap-2 bg-secondary/10 px-3 py-2 rounded-full border border-zinc-800">
              <span>📚 Currently learning:</span>
              <span className="text-primary">{config.developer.currentlyLearning.join(", ")}</span>
            </div>
            <div className="flex items-center gap-2 bg-secondary/10 px-3 py-2 rounded-full border border-zinc-800">
              <span>{config.developer.funFact}</span>
            </div>
            <div className="flex items-center gap-2 bg-secondary/10 px-3 py-2 rounded-full border border-zinc-800">
              <span>{config.developer.status}</span>
            </div>
          </motion.div>
