...
const SectionTitle = () => (
    ...
    >
        ...
        <div className="flex flex-col md:flex-row md:items-start justify-between gap-6">
            <div className="space-y-4 max-w-2xl">
                ...
                <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
                    A curated selection of hardware, embedded systems, and AI/ML projects — spanning{' '}
                    <span className="text-primary">real-time computer vision</span>,{' '}
                    <span className="text-primary">FPGA design</span>,{' '}
                    <span className="text-primary">IoT systems</span>, and{' '}
                    <span className="text-primary">intelligent prompt engineering</span>.
                </p>
            </div>
        ...
        <div className="flex items-center gap-6 pt-2 overflow-x-auto pb-2 scrollbar-hide">
            ...
            <div className="space-y-1 flex-shrink-0">
                <span className="text-xl sm:text-2xl font-bold text-primary">480hrs</span>
                <p className="text-xs sm:text-sm text-muted-foreground whitespace-nowrap">
                    AI/ML Training (NASSCOM)
                </p>
            </div>
        </div>
